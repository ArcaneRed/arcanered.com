...
! function (t) {
  ...
  i.resize = E(u, k), i.scroll = E(u, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), i.redraw = E(), i.location = function (t) {
    ...
    t = t || {}, p = !0, u.triggerHandler("__wf_destroy"), null != t.domready && (h = t.domready), f.each(r, m), i.resize.off(), i.scroll.off(), i.redraw.off(), o = [], a = [], "pending" === _.state() && A()
    ...
    var D = e.frame = function () {
      ...
      W = l(function (e) {
        function n() {
          ...
          if (r)
            for (D(n), e = P(), t = r; t--;)(i = u[t]) && i.render(e)
        }
        var i = {
          ease: f.ease[1],
          from: 0,
        ...
        e.init = function (t) {
          ...
          var t;
          this.active || (this.start || (this.start = P()), this.active = !0, t = this, 1 === u.push(t) && D(n))
        }, e.stop = function () {
          var e, n, i;
  ...
  i.define("scroll", t.exports = function (t) {
    ...
    function v(e) {
      ...
      if (!(i.env("design") || window.$.mobile && /(?:^|\s)ui-link(?:$|\s)/.test(a.className))) {
        var c, f = (c = a, h.test(c.hash) && c.host + c.pathname === n.host + n.pathname ? a.hash : "");
        if ("" !== f) {
          var d = t(f);
    ...
    return {
      ready: function () {
        var t = e.WF_CLICK_EMPTY,
          n = e.WF_CLICK_SCROLL;
        a.on(n, d, v), a.on(t, f, function (t) {
          t.preventDefault()
        })
      }
    }
    ...
    function A(n, i) {
      ...
      c && "/" === c.attr("href") && null == c.attr("aria-label") && c.attr("aria-label", "home"), a.button.attr("style", "-webkit-user-select: text;"), null == a.button.attr("aria-label") && a.button.attr("aria-label", "menu"), a.button.attr("role", "button"), a.button.attr("tabindex", "0"), a.button.attr("aria-controls", a.overlayContainerId), a.button.attr("aria-haspopup", "menu"), a.button.attr("aria-expanded", "false"), a.el.off(m), a.button.off(m), a.menu.off(m), S(a), s ? (C(a), a.el.on("setting" + m, function (t) {
        return function (n, i) {
          i = i || {};
          var r = f.width();
          S(t), !0 === i.open && $(t, !0), !1 === i.open && q(t, !0), t.open && e.defer(function () {
            r !== f.width() && z(t)
          })
        }
      }(a))) : (! function (e) {
